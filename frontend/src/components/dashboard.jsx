  ...
  return (
    <div className="min-h-screen bg-slate-50 pb-24 font-sans text-slate-900">
      <nav className="bg-white px-6 py-4 flex justify-between items-center shadow-sm border-b border-slate-100">
        <div className="text-xl font-black uppercase tracking-widest text-slate-900">
          Logbook
        </div>
        <div
          onClick={() => {
          ...
          <section>
            ...
            <div className="bg-slate-900 rounded-3xl p-6 shadow-xl relative overflow-hidden">
              ...
              <div className="relative z-10">
                <div className="text-indigo-400 font-bold text-sm mb-2 uppercase tracking-wide">
                  {capitalizeEachWord(today[0].day)}
                </div>
                <h3 className="text-3xl font-black text-white mb-2">
                  {capitalizeEachWord(today[0].name)}
                </h3>
        ...
        <section>
          ...
          <div className="grid sm:grid-cols-2 gap-5">
            {nottoday.map((division) => (
              <div
                key={division.id}
                className="bg-white p-5 rounded-3xl shadow-sm border border-slate-100 hover:shadow-md transition group"
              >
