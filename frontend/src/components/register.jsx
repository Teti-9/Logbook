...
const RegisterPage = (props) => {
  const { name, email, password, setName, setEmail, setPassword, setPage } =
    props;
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8 font-sans text-slate-900">
      <div className="sm:mx-auto sm:w-full sm:max-w-md text-center">
        <div className="text-3xl font-black uppercase tracking-widest text-slate-900 mb-6">
          Logbook
        </div>
        ...
        <div className="bg-white py-8 px-4 shadow-xl shadow-slate-200/50 sm:rounded-3xl sm:px-10 border border-slate-100">
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-slate-600 font-medium">
              ...
              <a
                onClick={() => setPage(2)}
                className="font-bold text-indigo-600 hover:text-indigo-500 transition cursor-pointer text-indigo-600"
              >
                Sign in
              </a>
            </p>
